...
--Draw gameover
drawWorldIO (World (Board sz ps pieces) turn _ _ _ _ _ True ) = return (pictures [ gameOverScreen, (drawText (getWinner (Board sz ps pieces)) 0 0)])

-- Draws hints for reversi start
drawWorldIO (World (Board sz ps pieces) turn _ _ _ True True _ ) = return 
       (pictures [ (drawBoardBMP sz)
                , (drawHints sz (checkStart (Board sz ps pieces)))
                , (drawPiecesBMP sz pieces)
        , drawText ("Black: " ++ (show $ evaluate (Board sz ps pieces) Black)) (-2300) (-500)
...
--Draw hints
drawWorldIO (World (Board sz ps pieces) turn _ _ _ True _ _) = return
       (pictures [ (drawBoardBMP sz)
                , (drawHints sz (checkAvailable (Board sz ps pieces) (0,0) turn))
                , (drawPiecesBMP sz pieces)
        , drawText ("Black: " ++ (show $ evaluate (Board sz ps pieces) Black)) (-2300) (-500)
...
-- Draw otherwise
drawWorldIO (World (Board sz ps pieces) _ _ _ _ _ _ _ ) = return 
  (pictures  [ (drawBoardBMP sz)
        , (drawPiecesBMP sz pieces)
        , drawText ("Black: " ++ (show $ evaluate (Board sz ps pieces) Black)) (-2300) (-500)
        , drawText ("White: " ++ (show $ evaluate (Board sz ps pieces) White)) (-2300) 0
